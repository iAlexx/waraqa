...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "site_settings" (
  	...
  	"verification_policy_days" numeric DEFAULT 90,
  ...
  CREATE TABLE "site_settings_locales" (
  	...
  	"tagline" varchar,
  	"independence_disclaimer" varchar NOT NULL,
  ...
  ALTER TABLE "site_settings_rels" ADD CONSTRAINT "site_settings_rels_transactions_fk" FOREIGN KEY ("tx_id") REFERENCES "public"."tx"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "site_settings_rels_tx_id_idx" ON "site_settings_rels" USING btree ("tx_id");`)
}
