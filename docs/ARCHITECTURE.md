...
**Related:** [CONTENT_MODEL.md](./CONTENT_MODEL.md), [RBAC.md](./RBAC.md), [EDITORIAL_WORKFLOW.md](./EDITORIAL_WORKFLOW.md), [SEARCH_ARCHITECTURE.md](./SEARCH_ARCHITECTURE.md), [TRANSACTION_DETAIL_ARCHITECTURE.md](./TRANSACTION_DETAIL_ARCHITECTURE.md), [CLAIMS_EVIDENCE.md](./CLAIMS_EVIDENCE.md)
